...
<style>
    ...
    /* Original animation styles from a.html */
    .pencil__body1,
    .pencil__body2,
    .pencil__body3,
    .pencil__eraser,
...
// Automatically show loading when page starts loading
window.addEventListener('beforeunload', showLoading);

// Hide loading when page is fully loaded
window.addEventListener('load', hideLoading);

// For AJAX requests, you can manually call showLoading() and hideLoading()
</script>